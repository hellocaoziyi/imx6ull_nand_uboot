...
CONFIG_IMX_CONFIG="board/freescale/mx6ull_caoziyi_nand/imximage.cfg"
...
CONFIG_MXC_GPIO=y
CONFIG_BOARDDIR="board/freescale/mx6ull_caoziyi_nand"
CONFIG_POWER=y
...
CONFIG_VIDEO=y
CONFIG_MFG_NAND_PARTITION="mtdparts=gpmi-nand:64m(boot),16m(kernel),16m(dtb),1m(misc),-(rootfs) "
...
CONFIG_EXTRA_ENV_SETTINGS="CONFIG_MFG_ENV_SETTINGS "panel=TFT50AB0splashimage=0x820000000fdt_addr=0x830000000fdt_high=0xffffffff0console=ttymxc00bootargs=console=ttymxc0,115200 ubi.mtd=3 root=ubi0:rootfs rootfstype=ubifs " CONFIG_BOOTARGS_CMA_SIZE "mtdparts=gpmi-nand:64m(boot),16m(kernel),16m(dtb),-(rootfs)0bootcmd=nand read ${loadaddr} 0x4000000 0x800000;nand read ${fdt_addr} 0x5000000 0x100000;bootz ${loadaddr} - ${fdt_addr}0""
